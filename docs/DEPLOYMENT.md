...
> **New to the repo? Start with [`../README.md`](../README.md) for setup/install.** This doc covers deployment specifics only.
...
```
Browser
  └── idmc_governance.ui.app :8080        (Web UI — FastAPI + HTML)
        ├── idmc_governance.servers.ai_governance :8770   (AI steps — calls Anthropic API)
        └── idmc_governance.servers.governance_engine :8765  (IDMC/CDQ rules, mappings)
```
...
| Server | Port | Purpose |
|---|---|---|
| `idmc_governance.servers.governance_engine` | 8765 | IDMC/CDQ API tools |
| `idmc_governance.servers.ai_governance` | 8770 | AI governance orchestration |
| `idmc_governance.ui.app` | 8080 | Web UI |
...
- Application: Python web server (idmc_governance.ui.app)
